            ...
            <div class="header-wrap">
                <div class="header-top d-flex justify-content-between align-items-center">
                    ...
                    <div class="main-menubar d-flex align-items-center">
                        <nav class="hide">
                            <a href="#home">Home</a>
                            <a href="#project">Donasi</a>
                            <a href="#about">About</a>
                            <a href="#donate">Zakat</a>
                        </nav>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 d-flex flex-column">
                                    <input name="fname" placeholder="Masukan nama" onfocus="this.placeholder = ''"
                                        onblur="this.placeholder = 'Masukan nama'" class="form-control mt-20"
                                ...
                                <div class="col-lg-12 d-flex flex-column">
                                    <input name="amound" placeholder="Jumlah (Rupiah)" onfocus="this.placeholder = ''"
                                        onblur="this.placeholder = 'Jumlah (Rupiah)'" class="form-control mt-20"
                                        required="" type="text">
